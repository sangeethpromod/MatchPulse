        ...
        <form>
          ...
          <div className="enter-teamDesc">
            ...
            <textarea
              ...
              placeholder="Eg: Bayern is one of the German Leauge club giants."
              rows="4"
            ></textarea>
            <p>Words: {wordCount}</p>
          </div>
          ...
          <div className="bundesliga-trophy-count">
            <h1>BUNDESLIGA TROPHIES WON</h1>
            <input
          ...
          <div className="dfbpokal-trophy-count">
            <h1>DFB-POKAL TROPHIES WON</h1>
            <input
              className="enter-trophy-name-input"
              type="text"
              placeholder="0"
          ...
          <div className="dflsuper-trophy-count">
            <h1>DFL SUPER CUP TROPHIES WON</h1>
            <input
              className="enter-trophy-name-input"
              type="text"
          ...
          <div className="enter-managerDesc">
            ...
            <textarea
              className="enter-team-Desc-textarea"
              placeholder="Eg: Jürgen Klopp is regarded as on of the best German Coaches in the world."
              rows="4"
            ></textarea>
            <p>Words: {wordCount}</p>
          </div>
